...
define(['goo/entities/EntityUtils', 'goo/math/Vector3', 'goo/renderer/TextureCreator', 'goo/renderer/Material', 'goo/renderer/shaders/ShaderLib',
	...
	function Blood( goo) {
		...
		var particleTex = new TextureCreator().loadTexture2D('res/images/flare.png');
		...
		this.config = {
			...
			emitters : [{
				...
				getEmissionVelocity : function (particle/*, particleEntity*/) {
					...
					return ParticleUtils.getRandomVelocityOffY(vec3, 0, 0, 0);
				}
			}]
		};
	...
	Blood.prototype.spawn = function( pos) {
		...
		particleComponent.emitters[0].influences.push(ParticleUtils.createConstantForce(new Vector3(0, 0.4, 0)));
